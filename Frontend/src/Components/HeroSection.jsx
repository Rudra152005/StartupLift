    ...
    <section className="relative bg-[#0B0B14] text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-24 md:py-32">
        ...
        <div className="md:w-1/2 text-center md:text-left space-y-6 animate-fadeIn">
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight text-[#E4E4E7]">
            Empowering <br />
            Startups to <br />
          ...
          <div className="pt-4">
            <button className="bg-linear-to-r from-[#7832FF] to-[#5B21B6] text-white px-8 py-3 rounded-lg font-medium shadow-[0_0_25px_#7832FF50] hover:scale-105 hover:shadow-[0_0_35px_#7832FF70] transition-all duration-300">
              Join Now
            </button>
          </div>
        </div>
